...
const ChangePassword = () => {
    return (
       ...
       <div class="grid gap-4 mb-6 md:grid-cols-1">
           <div>
               <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Old password</label>
           ...
           <div>
               <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Re-enter password</label>
       ...
       <button type="submit" class="text-white bg-[#04d1b2] focus:ring-1 focus:outline-none  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
   </form>
    )
}
