...
import WorkerDetails from './WorkersDetails'
...
const ViewOutlet = () => {
    ...
    const getOutlet = async () => {
        return await axios({
            method: 'GET',
            url: `${process.env.REACT_APP_API}/api/GetOutletbyId/${id}`,
            headers: {
                'Authorization': 'Bearer ' + getCookie('token')
            },
        })
        ...
        <div class="flex-1 max-w-5xl md:max-w-5xl mx-6 p-1 mt-5">
                        ...
                        <div class="mt-2 flex items-center text-sm text-gray-500">
                            <div class="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <div class="pl-3">
                                    ...
                                    {outlet?.dataOutlet?.userR?.map((ele) =>
                                        (ele.Post === "Manager") ?
                                            (
                                                <>
            ...
            <div class="flex-1 pb-6 max-w-5xl md:max-w-6xl mx-auto p-1 mt-6">
                ...
                <ul class="grid grid-cols-1">
                    <li>
                         <WorkerDetails workers={outlet?.dataOutlet}/>
                    </li>
                </ul>
            </div>
        </div>
